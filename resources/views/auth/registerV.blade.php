...
<div class="login-container">
  <section class="login" id="login">
    ...
    <form class="login-form" action="{{route('regist')}}" method="POST">
    @csrf
    <input type="text" value="{{old('name')}}" name="name"class="form-control  {{$errors->has('name')?'is-invalid':''}}" name="name" value="{{ old('name') }}" placeholder="Name" autocomplete="off" required autofocus/>
    @if($errors->has('name'))
    <div class="invalid-feedback">
    {{$errors->first('name')}}
    </div>
    @endif
    <input type="email" value="{{old('email')}}"  name="email" class="form-control mt-3 {{$errors->has('email')?'is-invalid':''}}" placeholder="Email" required autofocus/>
...
@if($errors->has('email'))
    ...
    <input type="password" name="password" class="form-control mt-3{{$errors->has('password')?'is-invalid':''}}" placeholder="Password" required/>
    ...
    <input type="password" name="password_confirmation" class="form-control mt-3 {{$errors->has('password_confirmation')?'is-invalid':''}}" placeholder="Confirmation Password" required/>
